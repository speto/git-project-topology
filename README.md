...
```text
~/Workspace/t7/speto/workspace-relay
...
```text
~/Workspace/t7/speto/workspace-relay
~/Workspace/t7/speto/workspace-relay/.git
~/Workspace/t7/speto/workspace-relay/main
~/Workspace/t7/speto/workspace-relay/main/src
```
...
{
  projectRoot: {
    canonicalPath: '/Volumes/t7-workspace/speto/workspace-relay',
    displayPath: '~/Workspace/t7/speto/workspace-relay',
  },
  git: {
    commonDirectory: {
      canonicalPath: '/Volumes/t7-workspace/speto/workspace-relay/.git',
      displayPath: '~/Workspace/t7/speto/workspace-relay/.git',
    },
    bare: true,
    worktrees: [
      {
        path: {
          canonicalPath: '/Volumes/t7-workspace/speto/workspace-relay/main',
          displayPath: '~/Workspace/t7/speto/workspace-relay/main',
        },
        head: '…',
        branch: 'main',
  ...
  selection: {
    ...
    path: {
      inputPath: '~/Workspace/t7/speto/workspace-relay',
      absolutePath: '/Users/me/Workspace/t7/speto/workspace-relay',
      canonicalPath: '/Volumes/t7-workspace/speto/workspace-relay',
      displayPath: '~/Workspace/t7/speto/workspace-relay',
    },
  },
...
// /Volumes/t7-workspace/speto/workspace-relay/main/src
```
...
This is intended for consumers such as `agent-project-topology`; they should not reimplement `~`, symlink, or canonical-path handling.
...
const topology = await inspectProjectTopology('./project', {
  cwd: '/workspace',
  gitBinary: '/opt/homebrew/bin/git',
  gitTimeoutMs: 15_000,
});
```
...
Those belong in consuming applications or higher-level libraries such as an eventual `agent-project-topology`.
